...
uses
  ...
  fRelFaixaEtaria in 'fRelFaixaEtaria.pas' {ovRel_FaixaEtaria},
  fRelFiltrosPadrao in 'fRelFiltrosPadrao.pas' {ovF_RelFiltrosPadrao},
  fRelFiltrosFaixaEtaria in 'fRelFiltrosFaixaEtaria.pas' {ovF_RelFiltrosFaixaEtaria};
